...
namespace core_api.Controllers.client
{
    ...
    public class HomeController : Controller
    {
        ...
        [HttpGet("filter/{pageIndex}/{pageSize}")]
        public async Task<ActionResult> GetFilteredProducts([FromQuery] string[] ram, [FromQuery] string[] rom, int pageIndex, int pageSize )
        {
            var filteredProducts = await _homePageService.GetFilteredProducts(ram, rom, pageIndex, pageSize);
